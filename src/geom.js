...
const intersectionBetweenPoints = (p0, p1, p2, p3) => {
...
const linearEquationFromPoints = (p0, p1) => {
  var dx = p1.x - p0.x;
  var dy = p1.y - p0.y;
...
const intersectionAnywhere = (p0, p1, p2, p3) => {
...
const linearInterpolate = (a, b, ratio) => {
  return {
    x: a.x + (b.x - a.x) * ratio,
    y: a.y + (b.y - a.y) * ratio
  };
...
const parallelPoints = (p0, p1, offset) => {
