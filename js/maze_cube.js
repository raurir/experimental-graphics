var maze_cube = function() {
	...
	function init() {
		...
		makeFace({rotation: {x: 0}, colour: 0xff0000});
		makeFace({rotation: {x: 1, z: 1.5}, colour: 0x00ff00});
		makeFace({rotation: {x: 0.5, z: 0.5}, colour: 0x0000ff});
		makeFace({rotation: {x: 1.5, z: 1}, colour: 0xffff00});
		makeFace({rotation: {y: 0.5, z: 1.5}, colour: 0xff00ff});
		makeFace({rotation: {y: 1.5, z: 1}, colour: 0x00ffff});
