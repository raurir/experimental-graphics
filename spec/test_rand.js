	...
	describe("shuffle", () => {
		it("should shuffle an array", () => {
			...
			expect(
				rand
					.shuffle(
						"The Karl G. Jansky Very Large Array (VLA) is a centimeter-wavelength radio astronomy observatory located in central New Mexico on the Plains of San Agustin, between the towns of Magdalena and Datil, ~50 miles (80 km) west of Socorro. The VLA comprises twenty-seven 25-meter radio telescopes deployed in a Y-shaped array.".split(
							" ",
						),
					)
					.join(" "),
